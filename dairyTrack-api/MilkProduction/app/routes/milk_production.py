...
def update_batch_status(batch_id):
    try:
        ...
        # Update status
        batch.status = MilkStatus[new_status.upper()]
        batch.updated_at = datetime.utcnow()
        
        # Trigger notifications
        from app.services.notification import notify_batch_status_change
        notification_count = notify_batch_status_change(batch_id, old_status, batch.status)
